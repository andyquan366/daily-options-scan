...
# ✅ Put/Call Ratio 打分（满分 20）
        if put_call_ratio <= 0.1:
            ...
            score_pcr = 12
        elif put_call_ratio <= 3:
            score_pcr = 8
        elif put_call_ratio <= 6:
            score_pcr = 4
        else:
            score_pcr = 0
        ...
        for option_type, top_option in zip(['Call', 'Put'], [top_call, top_put]):
            records.append({
                ...
                'Premium Skew': premium_skew,'Volume Diff Ratio': round(volume_diff_ratio, 4), 
